    ...
    <article className="group w-full shadow-lg/60 shadow-purple-600/30 relative rounded-xl bg-[#0f1725] text-white hover:scale-105 transition-transform duration-1000 overflow-hidden">
      <picture className="h-56 max-h-56 w-full overflow-hidden block">
        <img
          ...
          src="https://imgs.search.brave.com/pus4VEr0cJ_mBSOj3uBx1JrDbFvbOY1PKcsK_KF0U5U/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9wcmVn/cmFkby51cGMuZWR1/LnBlL2ZhY3VsdGFk/LWRlLWFycXVpdGVj/dHVyYS9hcnF1aXRl/Y3R1cmEvaW1nL25l/dy1kZXNpbmcvd2h5/LXNsaWRlci9UYWxs/ZXItZGlzZW5vLWFy/cXVpdGVjdHVyYS5q/cGc"
        />
      </picture>
      ...
      <p className="text-gray-400 mb-4 flex-1 px-5">{content}</p>
